    ...
    fields.forEach(function (field) {
      ...
      if (field.hasAttribute('required') && value === '') {
        ...
        if (value.length < minLen) {
          errorMessage = getFieldLabel(field) + ' must be at least ' + minLen + ' characters.';
        }
      } else if (field.hasAttribute('maxlength') && value !== '') {
        const maxLen = parseInt(field.getAttribute('maxlength'), 10);
        if (value.length > maxLen) {
          errorMessage = getFieldLabel(field) + ' must not exceed ' + maxLen + ' characters.';
        }
      }
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '76eac0de-7c2b-4449-a178-cbeb861a1b4d',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '76eac0de-7c2b-4449-a178-cbeb861a1b4d';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '76eac0de-7c2b-4449-a178-cbeb861a1b4d';
